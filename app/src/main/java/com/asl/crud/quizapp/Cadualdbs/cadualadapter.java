...
public class cadualadapter extends RecyclerView.Adapter<cadualadapter.Myholder> {
    ...
    private int Score=0;
    public cadualadapter(Context applicationContext, List<cadualentity> cadualentities) {
        this.mcontext=applicationContext;
        this.cadualentities=cadualentities;
    }

    public cadualadapter() {

    }

    @NonNull
    @Override
    public cadualadapter.Myholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.basicsinglelayout,viewGroup,false);
        return new cadualadapter.Myholder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final cadualadapter.Myholder myholder, int i) {
