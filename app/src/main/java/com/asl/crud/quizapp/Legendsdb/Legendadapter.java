...
public class Legendadapter extends RecyclerView.Adapter<Legendadapter.Myholder> {
    ...
    public Legendadapter(Context applicationContext, List<Legendentity> legendentities) {
    ...
    public Myholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new Legendadapter.Myholder(v);
    }
