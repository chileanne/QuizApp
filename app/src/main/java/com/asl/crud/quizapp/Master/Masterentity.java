...
public class Masterentity {
    ...
    public Masterentity(@NonNull int ids, @NonNull String mquestion, @NonNull String moptionA, @NonNull String moptionB, @NonNull String moptionC, @NonNull String moptionD, @NonNull String mcorrectanswer, @NonNull String mquestionid, @NonNull String mshort) {
        this.ids = ids;
