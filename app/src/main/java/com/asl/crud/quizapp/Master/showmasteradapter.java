...
public class showmasteradapter extends RecyclerView.Adapter<showmasteradapter.Myholder>  {
    private Context mcontext;
    private List<Masterentity> masterentities;

    public showmasteradapter(Context applicationContext, List<Masterentity> masterentities) {
    ...
    @NonNull
    @Override
    public showmasteradapter.Myholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.basicsinglelayout,viewGroup,false);
        return new showmasteradapter.Myholder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull showmasteradapter.Myholder myholder, int i) {
